...
(function($){
  $.fn.fold = function(options) {
    ...
    var defaults = {
      ...
      turnImage: '<?php bloginfo('template_url'); ?>/corner/fold-ln.png', // The triangle-shaped fold image
      maxHeight: 80,         // The maximum height. Duh.
      startingWidth: 30,     // The height and width 
      startingHeight: 30,    // with which to start (these should probably be camelCase, d'oh.)
    ...
    var turn_hideme = $('<div id="turn_hideme" class="turn_hideme">');
    var turn_wrapper = $('<div id="turn_wrapper" class="turn_wrapper" style="position:absolute;top:0;">');
    var turn_object = $('<div id="turn_object" class="turn_object">');
    var img = $('<img id="turn_fold" class="turn_fold" src="'+ (options.turnImage) +'">');
