...
<a rel="nofollow" class="media" href="<?php echo (!empty($facebook_id)) ? $facebook_url : get_option('adjump_facebook_link'); ?>  " title="Facebook" target="_blank"><div id="fb_button"></div></a>
	<?php }?>
    	<?php if(get_option('adjump_twitter_link')!=""){ ?>
           <a rel="nofollow" class="media"  href="<?php echo (!empty($twitter_id)) ? $twitter_url : get_option('adjump_twitter_link'); ?>" title="Twitter" target="_blank"><div id="tw_button"></div></a>
           <?php }?>
...
<a class="media" href="<?php echo get_option('adjump_rss_link'); ?>" title="RSS" target="_blank"><div id="rss_button"></div></a>
 <?php }?>
           ...
           <a class="media" href="<?php echo get_option('adjump_youtube_link'); ?>" title="<?php bloginfo('name'); ?> on Youtube"><div id="ut_button"></div></a>
           <?php } */?>
