...
//9) Should do something with expired (add display checkbox) and where to display should I move into expired?
 ...
 <div class="coupon-post">
        <div class="post-image"><a target="_blank" href="<?php the_permalink(); ?>"><img src="<?php echo Images::getPostImageUrl(); ?>" alt="<?php the_title() ;?>" title="<?php the_title() ;?>" border="0"></a></div>
        <div class="post-entry">
          <h6><?php the_title() ;?></h6>
          <a target="_blank" href="<?php the_permalink(); ?>" class="get-dash-btn" title="<?php echo $this_post->getButtonText(); ?>" ><?php echo $this_post->getButtonText(); ?></a>
          <p><?php the_content() ;?></p>
