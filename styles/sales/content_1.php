...
<?php if  (($this_post->compareDate())==FALSE){?>
 <div class="free-samples-post">
        <div class="post-image-300"><a href="<?php echo $this_post->getPermalink(); ?>"><img width="300" height="250" src="<?php echo $this_post->getPostImage(); ?>" alt="<?php echo $this_post->getTitle(); ?>" title="<?php echo $this_post->getTitle(); ?>" border="0"></a>
...
<!--          <span class="date">august 31, 2012</span> -->
         <span>
<!--          <span class="category">clothes & fashion, contest, facebook</span> -->
