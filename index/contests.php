<?php $this_post=new Post(); ?>
 ...
 <div class="index-post-300 post">
        <div class="post-image-300"><a href="<?php echo $this_post->getPermalink(); ?>"><img width="300" height="250" src="<?php echo $this_post->getPostImage(FALSE, TRUE); ?>" alt="<?php echo $this_post->getTitle(); ?>" title="<?php echo $this_post->getTitle(); ?>" border="0"></a></div>
        ...
        <a href="<?php echo $this_post->getPermalink(); ?>"><h6><?php echo $this_post->getTitle(); ?></h6></a>
         <p class="deatails" id="deatails">
          ...
          <p><?php echo $this_post->getExcerpt(200); ?></p>
          <?php $this_post->getBrandLink(TRUE); ?> 
          </div>
          <a href="<?php echo $this_post->getPermalink(); ?>" class="get-btn" title="<?php echo $this_post->getButtonText('Contests'); ?>"><?php echo $this_post->getButtonText('Contests'); ?></a>
        </div>
        <div class="counts">
