...
$excerpt=preg_replace('#<p>([^<]*?)</p>#msi', '$1',$excerpt);
 ...
 <?php } ?>
        <div class="post-image-300"><a href="<?php echo $this_post->getPermalink();?>"><img width="300" height="250" src="<?php echo $this_post->getPostImage(TRUE);?>" alt="<?php echo $this_post->getTitle();?>" title="<?php echo $this_post->getTitle();?>" border="0"></a></div>
